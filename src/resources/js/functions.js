...
export function htmlAjaxRequest(url, type, data, successCallback = function (result) { console.log(result); }, failureCallback = function (error) { console.log(error); }, alwaysCallback = function () { }) {
    var setting = {
        url: url,
        type: type,
        cache: false,
...
export function jsonAjaxRequest(url, type, data, successCallback = function (result) { console.log(result); }, failureCallback = function (error) { console.log(error); }, alwaysCallback = function () { }) {
    var setting = {
        url: url,
        type: type,
        cache: false,
...
export function startSpinner() {
    $(".cv-spinner-overlay").fadeIn(300);
}

export function stopSpinner() {
    $(".cv-spinner-overlay").fadeOut(300);
}
